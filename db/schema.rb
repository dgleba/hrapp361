...
ActiveRecord::Schema.define(version: 50161230223315) do
  ...
  create_table "stf_assets", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "assetnum"
    t.string   "description",                                                     collation: "utf8_unicode_ci"
    t.integer  "active_status", default: 1
    t.integer  "sort"
    t.datetime "created_at",                                         null: false
    t.datetime "updated_at",    default: -> { "CURRENT_TIMESTAMP" }, null: false
  ...
  create_table "versions_dc", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4" do |t|
    t.string   "item_type",      limit: 191,        null: false
    t.integer  "item_id",                           null: false
    t.string   "event",                             null: false
    t.string   "whodunnit"
