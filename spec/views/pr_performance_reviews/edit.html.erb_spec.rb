...
RSpec.describe "pr_performance_reviews/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit pr_performance_review form" do
    render

    assert_select "form[action=?][method=?]", pr_performance_review_path(@pr_performance_review), "post" do
